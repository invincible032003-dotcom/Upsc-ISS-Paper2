...
.topic-heading { page-break-before: always; font-family: Arial, sans-serif; font-size: 15pt; color: #e8eaf0; border-bottom: 2px solid var(--accent, #b79cf0); padding-bottom: 6px; margin: 0 0 4px; }
...
.qnum { font-weight: 700; color: var(--accent, #b79cf0); margin-right: 4px; }
...
.reveal { background: #211a33; border: 1px solid #4d3d78; border-left: 3px solid #8b6fe0; border-radius: 8px; padding: 7px 12px; margin-bottom: 6px; }
.reveal .reveal-title { font-family: Arial, sans-serif; font-size: 8.8pt; text-transform: uppercase; letter-spacing: 0.04em; color: #b79cf0; display: flex; align-items: center; gap: 6px; margin-bottom: 3px; }
